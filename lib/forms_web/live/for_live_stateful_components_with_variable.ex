defmodule FormsWeb.ForLiveStatefulComponentsWithVariable do
  ...
  def render(assigns) do
    ...
    <ol>
      <%= for day <- @week do %>
        <% backwards_day = String.reverse(day) %>
        <%= live_component @socket, DayComponent, id: day, day: backwards_day %>
      <% end %>
    </ol>
    """
